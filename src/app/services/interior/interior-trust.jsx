...
export default function InteriorTrustSection() {
  const logos = [
    { src: '/trusted-badges/trust1.png', alt: 'Logo 1', href: 'https://30oldmill.com/' },
...
const testimonials = [
  {
    quote: 'Our condo suites were painted with precision. Walls, ceilings, and trim all look brand new.',
    name: 'Sammy Reyes',
  ...
  {
    quote: 'The crew was careful with our tenants’ belongings and left the space spotless after painting.',
    name: 'Daniel Novak',
  ...
  {
    quote: 'Excellent finish quality—neutral colors applied evenly across multiple units. Professional team.',
