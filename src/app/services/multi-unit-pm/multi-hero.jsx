  ...
  const cardImgs = [
    {
      ...
      bullets: ['Interior repaint of all suites', 'Hallway & common area painting', 'Exterior façade touch-ups'],
    },
    {
      src: '/condoca/hero.jpg',
      alt: 'Condo CA exterior repaint in progress',
      title: 'Condo CA Complex',
      bullets: ['Lobby & reception repaint', 'Amenity room painting', 'Exterior window trim refinishing'],
    },
    {
      src: '/strata/hero.jpg',
      alt: 'Strata building stairwell and railings repaint',
      title: 'Strata Residences',
      bullets: ['Stairwell & railing painting', 'Unit door enamel systems', 'Underground parking repaint'],
    },
  ];

  return (
    <section
      aria-label="Classic Contracting hero"
      ...
      <div className="flex-grow flex flex-col justify-center mx-auto max-w-7xl px-4 lg:px-8 py-8 lg:py-12">
        ...
        <div className="grid gap-6 lg:grid-cols-12 items-center flex-grow">
          ...
          <div className="lg:col-span-6 rounded-xl p-5 sm:p-6 h-full flex flex-col justify-center">
            <div className="relative">
              ...
              <p className="mt-1 text-base sm:text-lg text-[var(--text-200)]">
                Built for property managers & builders. We coordinate notices, protect tenant spaces, and deliver
                spotless turnover—on schedule.
              </p>
          ...
          <div className="lg:col-span-6 rounded-xl border-[var(--bg-300)] overflow-hidden h-full relative flex">
            {/* Positioned wrapper for `fill` image */}
            <div className="relative w-full h-full min-h-[320px] lg:min-h-[420px]">
              ...
              <div className="absolute w-full top-6 left-1/2 -translate-x-1/2 bg-white/80 backdrop-blur-sm border border-[var(--bg-300)] rounded-xl shadow-md max-w-sm p-4">
                <p className="text-sm sm:text-base text-[var(--text-200)] italic">
                  “30 units were completed in half the time than what was agreed on. Fast, reliable, and always on time.
                  Highly recommended.”
                </p>
        ...
        {/* Cards: 3 images with bullets */}
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 flex-shrink-0">
          {cardImgs.map((img) => (
            <div
              key={img.src}
              className="group border rounded-2xl border-[var(--bg-300)] bg-white shadow-sm overflow-hidden"
            >
              {/* Positioned wrapper for `fill` image */}
              <div className="relative w-full h-64 sm:h-72 lg:h-80">
                <Image
                  ...
                  loading="lazy"
                  decoding="async"
                  className="object-cover transition will-change-transform scale-[1.02] group-hover:scale-105"
