...
export default function CommercialProjectHighlights() {
  ...
  return (
    <section className="py-16 lg:py-20" aria-label="Commercial Project Highlights">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <header className="mb-8 text-center">
          ...
          <p className="mt-3 text-[var(--text-200)]">
            Examples of durable, low-odor finishes delivered for offices, retail, and multi-unit facilities across the GTA.
          </p>
        </header>
        ...
        <div className="relative">
          <div
            ...
            aria-label="Recent commercial project images"
          >
        ...
        <div className="mt-10 text-center">
          <HeroCta2
            title="Commercial Painting, Done Right"
            subtitle="Offices • Retail • Multi-Unit • Facilities"
            buttontext="Get Commercial Estimate →"
