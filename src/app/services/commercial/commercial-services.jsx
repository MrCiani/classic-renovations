...
const SERVICES = [
  {
    ...
    icon: Paintbrush,
    items: [
      'Low-odor, fast-cure systems for occupied spaces',
      'Night & weekend scheduling to reduce disruption',
      'Crisp lines, wall/trim/door packages',
      'Protection of furniture, flooring, and IT',
      'Suite turnovers & phase planning',
    ],
  },
  {
    ...
    items: [
      ...
      'Proper de-gloss & adhesion primers',
      'Fine-finish spray or roll as specified',
      'Hardware masked & protected',
      'High-touch area durability focus',
    ],
  },
  {
    ...
    items: [
      ...
      'Impact-resistant coatings (eggshell/satin)',
      'Baseboard, trim, elevator surrounds',
      'Signage & fire door coordination',
      'Clean turnovers with minimal downtime',
    ],
  },
  {
    title: 'Stairwells, Parkades & Back-of-House',
    icon: SquareStack,
    items: [
      'Anti-slip treads & line-marking',
      'Concrete, CMU, and steel substrates',
      'Rust-inhibitive primers on metal',
      'Numbering, stencils & wayfinding',
  ...
  },
  {
    ...
    icon: Ruler,
    items: [
      'Power wash / degrease / decontaminate',
      'Scrape, sand, patch & spot-prime',
      'Sealants/caulking at joints & gaps',
      'Drywall skim & blend to Level 4/5',
      'Full masking, hoarding & floor protection',
    ],
  },
  {
    title: 'Staining, Clear & Specialty Finishes',
    icon: Brush,
    items: [
      'Reception millwork & feature walls',
      'Wood stains, toners & clears',
      'Fine-finish spray where specified',
      'Mockups & samples for approval',
...
export default function CommercialServicesMenu() {
  ...
  return (
    <section
      ...
      aria-label="Commercial painting scopes and services"
    >
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <header className="mb-10 text-center">
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[var(--text-100)]">
            Professional <span className="text-[var(--primary-100)]">Commercial Painting</span> Services
          </h2>
          <p className="mt-3 max-w-2xl mx-auto text-[var(--text-200)] text-lg">
            Offices, retail, multi-unit common areas, stairwells, and parkades—dust-controlled prep, low-odor systems,
            and durable finishes delivered with minimal disruption.
          </p>
        </header>
