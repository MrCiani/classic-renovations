...
export default function CommercialTrustSection() {
  const logos = [
    { src: '/trusted-badges/trust3.png', alt: 'Houseful', href: 'https://www.houseful.ca/' },
    { src: '/trusted-badges/trust2.png', alt: 'LaSalle Park Retirement', href: 'https://www.lasalleparkretirement.com/' },
  ];
  ...
  const testimonials = [
    ...
    {
      quote: 'Minimal disruption, clear communication, and on-schedule delivery.',
  ...
  return (
    <section
      ...
      aria-label="Commercial trust and testimonials"
    >
      <div className="mx-auto max-w-7xl flex flex-col justify-center items-center gap-5 px-4 lg:px-8">
        ...
        <header className="mb-8 text-center">
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[var(--text-100)]">
            Trusted by property & facility managers across the GTA
          </h2>
          <p className="mt-3 text-[var(--text-200)] max-w-2xl mx-auto">
            Low-odor systems, dust-controlled prep, and professional finishes with minimal disruption to tenants and operations.
          </p>
        </header>
