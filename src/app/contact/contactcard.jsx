...
import { Phone, Mail, Building2, MapPin, Clock, ShieldCheck } from 'lucide-react'
          ...
          <div className="rounded-2xl border border-[var(--bg-300)] bg-white/90 backdrop-blur p-6 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea name="message" rows={5} className="w-full rounded-xl border border-[var(--bg-300)] px-3 py-2 outline-none focus:ring-2 focus:ring-[var(--accent-100)]" placeholder="Tell us about the scope, timing, and location" />
              </div>
              ...
              <div className="sm:col-span-2 flex items-center justify-between gap-3">
                ...
                <p className="text-xs text-[var(--text-300)]">By sending, you agree to our privacy policy.</p>
              </div>
