...
const IMAGES = [
  { src: '/houseful/photo1.jpg', alt: 'Houseful home interior living room with freshly painted walls and crisp trim' },
  { src: '/houseful/photo2.jpg', alt: 'Houseful kitchen with modern painted cabinetry, walls, and detailed trim' },
  { src: '/houseful/photo3.jpg', alt: 'Houseful exterior repaint featuring durable, weatherproof finish on siding and trim' },
  { src: '/houseful/photo4.jpg', alt: 'Houseful bedroom in neutral tones with clean wall finishes and white baseboards' },
  { src: '/houseful/photo5.jpg', alt: 'Houseful open-concept living area with accent wall repaint and sharp cut lines' }
];
