...
const IMAGES = [
  { src: '/venvi-birkdale/photo1.jpg', alt: 'Lobby repaint with modern neutral tones at Venvi Birkdale Place' },
  { src: '/venvi-birkdale/photo2.jpg', alt: 'Fresh corridor repaint using durable low-VOC paint for high-traffic areas' },
  { src: '/venvi-birkdale/photo3.jpg', alt: 'Two-bedroom model suite with newly painted walls and detailed trim finishes' },
  { src: '/venvi-birkdale/photo4.jpg', alt: 'One-bedroom suite living area featuring fresh coat of paint in warm tones' },
  { src: '/venvi-birkdale/photo5.jpg', alt: 'Door and frame refinishing with scuff-resistant enamel coating' },
  { src: '/venvi-birkdale/photo6.jpg', alt: 'Theatre room repaint with clean lines and refreshed trim work' },
];


export default function VenviBirkdaleGallery() {
...
const onTouchMove = (e) => {
  ...
  return (
    <>
      <Head>
        <title>Venvi Birkdale Place – Gallery | Classic Contracting</title>
        <meta
          name="description"
      ...
      <main className="mx-auto max-w-6xl px-4 lg:px-6 py-10">
        ...
        <header className="mb-6">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-[var(--text-100)]">
            Venvi Birkdale Place — Gallery
          </h1>
          <p className="text-[var(--text-200)] mt-2">
            Milton, ON • Suites &amp; common areas repaint
          </p>
        </header>
