...
const IMAGES = [
  {
    src: '/lasalle/photo1.jpg',
    alt: 'LaSalle Park Retirement grand interior staircase with freshly painted walls and trim'
  },
  {
    src: '/lasalle/photo2.jpg',
    alt: 'LaSalle Park Retirement resident bedroom with freshly painted neutral walls and clean trim'
  },
  {
    src: '/lasalle/photo3.jpg',
    alt: 'LaSalle Park Retirement in-suite living area with neutral painted walls and neat trim detail'
  },
  {
    src: '/lasalle/photo4.jpg',
    alt: 'High-traffic corridor repaint at LaSalle Park Retirement with durable low-VOC finish'
  },
    {
    src: '/lasalle/photo5.jpg',
    alt: 'LaSalle Park Retirement lobby with freshly painted neutral walls and crisp trim'
  }
];


export default function LaSalleGallery() {
...
const onTouchMove = (e) => {
  ...
  return (
    <>
      <Head>
        <title>LaSalle Park Retirement – Gallery | Classic Contracting</title>
        <meta
          name="description"
          content="LaSalle Park Retirement (Burlington, ON) painting gallery: lobby, corridors, suites, and amenity spaces."
        />
      </Head>
      ...
      <main className="mx-auto max-w-6xl px-4 lg:px-6 py-10">
        ...
        <header className="mb-6">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-[var(--text-100)]">
            LaSalle Park Retirement — Gallery
          </h1>
          <p className="text-[var(--text-200)] mt-2">
            Burlington, ON • Lobby, corridors, suites &amp; amenity repaint
          </p>
        </header>
