...
const IMAGES = [
  {
    src: '/strata/photo1.jpg',
    alt: 'Condo living room with freshly painted mint walls and crisp trim details'
  },
  {
    src: '/strata/photo2.jpg',
    alt: 'Interior corridor with clean, freshly painted walls and sharp contrast trim'
  },
  {
    src: '/strata/photo3.jpg',
    alt: 'Empty condo suite with freshly painted walls, crisp trim and clean neutral floors'
  },
  {
    src: '/strata/photo4.jpg',
    alt: 'Foyer with neutral wall paint, clean ceiling and base trim showcasing quality finishes'
  },
    {
...
export default function StrataGreenLife() {
...
const onTouchMove = (e) => {
  ...
  return (
    <>
      <Head>
        <title>Strata – Greenlife Golden Condos (7400 Markham Rd) – Gallery</title>
        <meta
          name="description"
          content="Painting gallery for Strata – Greenlife Golden Condos in Markham: lobby, corridors, and suites with fresh, durable finishes."
        />
      </Head>
      ...
      <main className="mx-auto max-w-6xl px-4 lg:px-6 py-10">
        ...
        <header className="mb-6">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-[var(--text-100)]">
            Strata — Greenlife Golden Condos (7400 Markham Rd) — Gallery
          </h1>
          <p className="text-[var(--text-200)] mt-2">
            Markham, ON • Lobby, corridors, suites &amp; amenity repaint
          </p>
        </header>
